...
| 阶段 | 负责组件 | 主要产物 | 说明 |
|------|----------|---------|------|
| Init | `/bewater-init` | `vision.md` `architecture.md` `constitution.md` `decision-log.md` `foundation-review.md` | 建立项目级北极星与约束，并推荐首个功能候选 |
...
- `vision.md` may contain Direction / Now / Next / Later, but not date-based roadmap commitments.
- `feature.md` must link back to `vision.md` before architect/design starts.
