...
Product framing path: `vision.md -> product-plan.md -> feature.md -> design.md -> tasks.md`
...
- `product-plan.md` - MVP-first 产品规划层：位于 `vision.md -> feature.md` 之间，把北极星转成 feature candidates、推荐 next feature、说明 observable effect、feedback value、Why Now 和 sequencing。它不是 PRD、不是日期 roadmap，也不是 `tasks.md` 的替代品。
